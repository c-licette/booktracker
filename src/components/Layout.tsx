...
import { LayoutDashboard, Rss, User, Settings, List, Menu, X } from 'lucide-react';
...
return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900 transition-colors duration-300 relative">
      ...
      <aside className={`
  fixed inset-y-0 left-0 z-50 w-64 glass-effect border-r transition-transform duration-300 ease-in-out
